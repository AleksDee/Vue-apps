        ...
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <!-- <input
            ...
            <input
                  ...
                  v-model="email">
                  <!-- <div>{{$v}}</div> -->
          <p v-if="$v.email.$invalid">Please provide a valid email address</p>
          <!-- <p v-if="!$v.email.mail">Please provide a valid email address</p> -->
          <!-- <p v-if="!$v.email.req">This field must not be empty</p> -->
          <div>
            <!-- {{ $v }} -->
          </div>
        </div>
  ...
  export default {
    ...
    validations: {
      email: {
        ...
        // unique: val => {
        //   if (val === '') return true;
          // return val !== 'are@mail.ru';
          // return new Promise((resolve, reject) => {
          //   setTimeout(() => {
          //     resolve(val !== 'are@mail.ru');
          //   }, 1000)
          // });
    ...
    methods: {
      ...
      onSubmit () {
        ...
        // axios.post('https://test-988c3.firebaseio.com/users.json', formData)
        // axios.post('', formData)
